...
class Simulator(Engine):
    ...
    def render(self):
        ...
        x = list(range(self._load['start'], self._load['stop'], self._load['step']))
...
out_format = lambda x, y: f'ressources/results/{x}_{y}.png'
in_format = lambda x: f'ressources/dataframes/{x}.csv'
